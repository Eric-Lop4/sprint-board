...
- **Fitxer:** `public/sprints.php`, `board.php`
- **Objectiu:** Mostrar esprints amb data d'inici i data de fi.
- **Tasques:** Afegir una pàgina perquè mostre els esprints així com l'enllaç per poder accedir a la pàgina.
